    ...
    Target Clean => _ => _
     ...
     private void AppBundle(string runtime) {
         HachimiPackagingAppBundle(x => x
             ...
             .SetIcon(Solution.WonderLab.Directory / "Assets" / "icon.icns")
